...
if __name__ == "__main__":
    ...
    df_T= pd.read_csv("/mnt/SSD1/bouazizs/GradCam/Probabilities/1.0_ T_St_Hiliaire.csv", delimiter='\t')
    ...
    outputFolder="/mnt/SSD1/bouazizs/GradCam/Probabilities_rockfall_conditions/continuous_freeze"
